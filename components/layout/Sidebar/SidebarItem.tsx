...
const SidebarItem: React.FC<SidebarItemProps> = ({label, href, icon: Icon, onClick}) => {
  console.log('this is sidebar item');
  return (
    <div className="flex flex-row items-center">
        ...
        <div className="relative hidden lg:flex items-center gap-4 px-4 py-2 rounded-full hover:bg-slate-300 hover:bg-opacity-10 cursor-pointer">
